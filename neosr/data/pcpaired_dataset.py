...
class pcpaired(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        hgt, wgt, _ = img_gt.shape
        hlq, wlq, _ = img_lq.shape
        d = np.array((hgt/hlq, wgt/wlq) , dtype='float32')
        ...
        return {"lq": img_lq, "gt": img_gt, "lq_path": lq_path, "gt_path": gt_path, 'd': d, 'orig_shape':(hgt, wgt)}
